...
_MIGRATIONPAYLOAD_OTPPARAMETERS.fields_by_name["algorithm"].enum_type = (
    _MIGRATIONPAYLOAD_ALGORITHM
)
_MIGRATIONPAYLOAD_OTPPARAMETERS.fields_by_name["digits"].enum_type = (
    _MIGRATIONPAYLOAD_DIGITCOUNT
)
_MIGRATIONPAYLOAD_OTPPARAMETERS.fields_by_name["type"].enum_type = (
    _MIGRATIONPAYLOAD_OTPTYPE
)
_MIGRATIONPAYLOAD_OTPPARAMETERS.containing_type = _MIGRATIONPAYLOAD
_MIGRATIONPAYLOAD.fields_by_name["otp_parameters"].message_type = (
    _MIGRATIONPAYLOAD_OTPPARAMETERS
)
